...
# para facilitar la visualización. siempre datos brutos para analisis pero transformados para imagenes. 
# ¿Qué es un boxplot?
...
# datos brutos: sale mal el boxplot	
...
abline(0, 1, col = "red")
#comparación valores eje x y y
#si variable x=variable y sale diagonal perfecta
...
# 426 diferencialmente expresados
...
# sobreexpresión (+) azul en lugar de roja porque así quedó al hacer la diferencia de medias
...
points (diff.mean[filter_combined & diff.mean > 0],
	-log10(pvalue[filter_combined & diff.mean > 0])
	, col = "blue")
